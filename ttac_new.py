...
def perform_update(for_client):
    app_name, app_version_string, app_version = app_info()
    ...
    app_update = for_client.update_check(app_name, app_version, channel=preferred_channel, strict=strict)
